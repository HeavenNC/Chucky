...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='Eq7nwZVrI2rlgxu83Oj7.NJBaaPWX4ChwW2QkFbp+nW.iA1Y/4sW8qHLreu6hbCTgOmdXNjKKdZrrOMtu09msZ4=')
nadya.loginResult()
print "=====[Sukses Login]====="
...
╠═════════════════════════
"""
tjia="u9e36c0029c31e1c1d6c36a8a7c13ff37"
	    ...
	    if mid in op.param3:	        
		    ...
		    G = nadya.getGroup(op.param1)
                    if len(G.members) <= wait["memberscancel"]:
                        ...
                        nadya.acceptGroupInvitation(op.param1)
			nadya.sendText(op.param1,"☆Ketik ☞Monika☜ Untuk Bantuan☆\n☆Harap Gunakan Dengan Bijak ^_^ ☆")
